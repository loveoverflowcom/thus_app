...
mixin _$Chat {
 ...
 String get id; String get title; List<String> get participantIds; Message? get lastMessage; DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,const DeepCollectionEquality().hash(participantIds),lastMessage,updatedAt);
...
@useResult
$Res call({
 String id, String title, List<String> participantIds, Message? lastMessage, DateTime? updatedAt
});
...
/// Create a copy of Chat
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? participantIds = null,Object? lastMessage = freezed,Object? updatedAt = freezed,}) {
...
as Message?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,
  ));
}
/// Create a copy of Chat
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  List<String> participantIds,  Message? lastMessage,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Chat() when $default != null:
return $default(_that.id,_that.title,_that.participantIds,_that.lastMessage,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  List<String> participantIds,  Message? lastMessage,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Chat():
return $default(_that.id,_that.title,_that.participantIds,_that.lastMessage,_that.updatedAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  List<String> participantIds,  Message? lastMessage,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Chat() when $default != null:
return $default(_that.id,_that.title,_that.participantIds,_that.lastMessage,_that.updatedAt);case _:
  return null;
...
class _Chat implements Chat {
  const _Chat({required this.id, required this.title, required final  List<String> participantIds, this.lastMessage, this.updatedAt}): _participantIds = participantIds;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,const DeepCollectionEquality().hash(_participantIds),lastMessage,updatedAt);
...
/// Create a copy of Chat
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? participantIds = null,Object? lastMessage = freezed,Object? updatedAt = freezed,}) {
  return _then(_Chat(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
